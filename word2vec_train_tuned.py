...
if __name__=="__main__":
    ...
    for num in list([3,4]):
        ...
        for i in range(int(len(train1[0])/3)):
            ...
            """
            validate_x[num-3].append(train1[0][index])
            validate_y[num-3].append(train1[1][index])
            del train1[0][index]
            del train1[1][index]
        train_x[num-3].append(train1[0])
        train_y[num-3].append(train1[1])
    ...
    for num in list([3,4]):
        ...
        current_x, current_y = train_x[num-3][0], train_y[num-3][0] 
        optimal_n_epochs = 0
        old_acc = 0.0
        new_acc = 0.0
        load=False
        ...
        while True:
            ...
            new_acc = evaluate_word2vec_cosine(validate_x[num-3], validate_y[num-3], embeddings, weights, bigram_unused_dictionary, "results.csv", bigram_split=False)
